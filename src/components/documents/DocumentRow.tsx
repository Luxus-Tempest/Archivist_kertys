    ...
    <tr className="group hover:bg-on-bg-gray-100 border-t-2 border-b-2 border-on-bg-gray-200 transition-colors">
      <td className="px-6 py-2">
        <div className="flex items-center gap-4 p-0!">
          {/*FILE ICON  */}
          <div className="relative w-10 h-10 bg-white rounded-lg border border-outline-variant/30 flex items-center justify-center overflow-hidden shadow-sm shrink-0">
            ...
            <div className="absolute inset-x-2 top-3 h-0.5 bg-slate-100 rounded w-4/5"></div>
            <div className="absolute inset-x-2 top-4 h-0.5 bg-slate-100 rounded w-2/3"></div>
          ...
          <div className="min-w-0 flex-1">
            <p className="font-bold text-xs text-on-surface-variant truncate">{name}</p>
            {size !== undefined && (
