...
export function MUIMenu({
  ...
  return (
      ...
      slotProps={{
        paper: {
          sx: {
            ...
            border: `1px solid ${isDark ? 'rgba(255, 255, 255, 0.1)' : 'rgba(226, 232, 240, 1)'}`,
    ...
    >
      {header && (
        <Box  sx={{ px: 2, py: 1.5, borderBottom: `1px solid ${isDark ? 'rgba(255,255,255,0.05)' : 'rgba(0,0,0,0.05)'}`, mb: 0.5 }}>
          <Typography
            sx={{
              fontSize: '10px',
              fontWeight: 900,
      ...
      {items.map((item, index) => (
        <MenuItem
          ...
          sx={{
            ...
            borderRadius: '8px',
            '&:hover': {
              backgroundColor: isDark ? 'rgba(255, 255, 255, 0.08)' : 'rgba(241, 245, 249, 1)',
