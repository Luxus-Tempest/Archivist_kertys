...
/**
 * A reusable, premium dropdown menu component designed for the DocPulseAI system.
      ...
      <div className="py-0">
        {items.map((item, index) => (
          <button
            ...
            className={`w-full flex items-center gap-2 px-6 py-2.5 text-left transition-all duration-200 group active:scale-[0.98] cursor-pointer ${item.variant === 'danger'
          ...
          >
            {item.icon && (
              <span className={`text-[18px] transition-colors flex items-center justify-center ${item.variant === 'danger'
